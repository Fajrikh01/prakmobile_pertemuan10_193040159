...
import id.ac.unpas.pertemuan10_193040159.ui.theme.Teal200
...
fun FormPencatatanSampahScreen(navController: NavHostController, id: String? = null, modifier: Modifier = Modifier)
{
        ...
        Row (modifier = Modifier
            ...
            Button(modifier = Modifier.weight(5f), onClick = {
                if (id == null) {
                    ...
                    scope.launch {
                        viewModel.update(id, tanggal.value.text, nama.value.text, berat.value.text)
                    }
                }
    ...
    if (id != null) {
        LaunchedEffect(scope) {
            viewModel.loadItem(id) { setoranSampah -> setoranSampah?.let {
